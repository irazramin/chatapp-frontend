      ...
      <div className="flex-1 mx-[1px]">
        <div className="px-[10px] md:px-[32px] py-[10px] md:py-[20px] bg-white w-full flex items-center justify-between">
          <div className="flex items-start gap-[10px] relative">
            ...
            <div>
              <h4 className="font-semibold text-xs md:text-[13px] text-black">
                Cameron Williamson
              </h4>
              <div className="leading-4 flex items-center gap-1 text-[10px] text-lightDark">
                <span className="inline-block w-2 h-2 bg-[#00B207] rounded-full"></span>{" "}
                Active now
              </div>
            </div>
          </div>
        ...
        <div
          ref={scrollRef}
          className="w-full h-[calc(100%-200px)] flex flex-col md:px-5 px-2 md:gap-5 gap-2"
        >
            ...
            <form action="#" onSubmit={(e) => handleOnSubmit(e)}>
              <div className="">
                <input
                  ...
                  name="sendMessage"
                  id="sendMessage"
                  className="w-full h-full p-5 focus:outline-0 text-sm font-medium"
