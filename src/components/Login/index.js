    ...
    return (
        <>
            <div className="w-[70%] mx-auto my-[100px] ">
                <h2 className="text-[26px] font-bold text-primary text-center">Sign In to Your Account</h2>
                ...
                <p className="text-light2 text-center text-[12px] leading-[14px] mt-10">oe use your email account</p>
                ...
                <div className="mt-[34px] text-center w-[70%] mx-auto">
                    <form onSubmit={(e) => handleSubmit(e)} action="#"
                        ...
                        <button
                            className="py-[15px] mt-[15px] bg-primary uppercase font-bold text-xs w-full rounded-3xl text-white hover:bg-secondary transition-all">Login
                        </button>
                        <button type="button" className="text-[13px] text-light font-semibold capitalize mt-[14px]">Forgot Password</button>
                    </form>
                </div>
            </div>
        </>
